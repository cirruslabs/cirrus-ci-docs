...
| CIRRUS_VAULT_AUTH_PATH     | `jwt` for JWT, etc.                                                                                                                                    | Alternative auth method mount point, in case it was mounted to a non-default path.                                                                                                                                                                                                                                                                                                                                  |
...
From the Cirrus CI's side, use the `CIRRUS_VAULT_URL` environment variable to point Cirrus CI at your vault and configure [other Vault-specific variables](#behavioral-environment-variables), if needed.

Once done, you will be able to use the `VAULT[path/to/secret selector]` syntax to retrieve a [v2 secret](https://developer.hashicorp.com/vault/docs/secrets/kv/kv-v2), for example:
